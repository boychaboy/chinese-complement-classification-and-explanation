...
class ComplBinProcessor(DataProcessor):
    """
    Data processor using DataProcessor class provided by BERT
    """
    def __init__(self, configs, tokenizer=None, complement=0):
        super().__init__()
    ...
    def _create_examples(self, data_dir, split, label=None):
        ...
        for i, line in enumerate(data):
            ...
            if line[1]==label_list[self.complement]:
    ...
    def get_dataloader(self, split, batch_size=1):
        ...
        dataset = ComplBinDataset(features)
